...
1. **Python:** Основной язык программирования для написания логики игры, управления состоянием и взаимодействия с пользователем.
2. **JSON:** Формат данных для хранения информации о персонажах, локациях, диалогах и других элементах игры.
3. **Pygame:** Библиотека для создания графического интерфейса и управления мультимедийными ресурсами, такими как изображения и звуки.
4. **SQLite:** Легкая база данных для хранения и управления данными игры. Подходит для локального хранения данных и быстрого доступа к ним.
5. **CustomTkinter:** Расширение Tkinter, которое предоставляет более современный и гибкий интерфейс для создания GUI.
6. **Git:** Система контроля версий для отслеживания изменений в коде и совместной работы над проектом.
